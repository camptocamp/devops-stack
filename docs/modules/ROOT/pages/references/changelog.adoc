...
== https://github.com/camptocamp/devops-stack/tree/v0.40.0[0.40.0] (2021-07-21)

https://github.com/camptocamp/devops-stack/compare/v0.39.0...v0.40.0[Full Changelog]

*Implemented enhancements:*

* feat: create dedicated AppProject for DevOps Stack Applications https://github.com/camptocamp/devops-stack/pull/685[#685] (https://github.com/mcanevet[mcanevet])
* feat: allow to configure ArgoCD repositories https://github.com/camptocamp/devops-stack/pull/686[#686] (https://github.com/mcanevet[mcanevet])
* feat(aks): create UAI and corresponding AzureIdentities and AzureIdentityBindings https://github.com/camptocamp/devops-stack/pull/689[#689] (https://github.com/mcanevet[mcanevet])
* feat: use loose dependencies in Terraform modules https://github.com/camptocamp/devops-stack/pull/696[#696] (https://github.com/mcanevet[mcanevet])

*Documentation:*

* fix: update reference adoc files https://github.com/camptocamp/devops-stack/pull/688[#688] (https://github.com/fsismondi[fsismondi])
* fix: update reference adoc files https://github.com/camptocamp/devops-stack/pull/688[#691] (https://github.com/fsismondi[fsismondi])
* refactor: pipelines documentation https://github.com/camptocamp/devops-stack/pull/692[#692] (https://github.com/fsismondi[fsismondi])

*Fixed Bugs:*

* fix: deploy keys should not be tight to the DevOps Stack https://github.com/camptocamp/devops-stack/pull/687[#687] (https://github.com/mcanevet[mcanevet])
* fix: dropping aad-pod-identity's deprecated forceNameSpaced in favour of new forceNamespaced https://github.com/camptocamp/devops-stack/pull/690[#690] (https://github.com/fsismondi[fsismondi])
* fix(aks): expose UAI's principal IDs https://github.com/camptocamp/devops-stack/pull/693[#693] (https://github.com/mcanevet[mcanevet])
* fix: add missing version contraint on null provider https://github.com/camptocamp/devops-stack/pull/697[#697] (https://github.com/mcanevet[mcanevet])
